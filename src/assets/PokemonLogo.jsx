...
const PokemonLogo = () => {
  return (
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 269.5 98.8" width="450"
      height="200">
      <linearGradient id="polygon16_1_" gradientUnits="userSpaceOnUse" x1="426.751" y1="-632.71"
        ...
        <stop offset="0" style={{stopColor:"#0070b6"}}/>
        <stop offset="1" style={{stopColor:"#1d2c5e"}} />
      </linearGradient>
      <path id="polygon16" className="st0" d="M0 36.6l12 20.3 4.8-4.6L3.7 32.8z" />
      <path id="polygon18" className="st1" d="M178.6 20.6l-.5 2.7 5.7-1.9-.7-3.3z" />
      ...
      <path id="polygon25" className="st2" d="M145 2.3l-18.5 21.2 5.4-1.5 17.6-22z" />
      <path id="polygon27" className="st3" d="M244.1 31.3l4.5-2.4-1.3 11.4z" />
      <path id="polygon29" className="st3" d="M215.8 38.6l4.1.9L225 37l-4.5-1.7z" />
      ...
      <path id="polygon36" className="st4" d="M76.6 26.6l.6 13.1 5.7-2.2-1.7-13.4z" />
      <linearGradient id="polygon43_1_" gradientUnits="userSpaceOnUse" x1="632.347" y1="-614.834"
        ...
        <stop offset="0" style={{stopColor:"#125d9e" }}/>
        <stop offset="1" style={{stopColor:"#1d2c5e" }}/>
      </linearGradient>
      <path id="polygon43" className="st5" d="M220.2 22.6l-4.5 2.5.1 13.5 4.6-2.3 1.4-6.6z" />
      <path id="polygon45" className="st6" d="M219.6 39.5l-5 44.4 8-1.6 1.5-45.2z" />
      <path id="polygon47" className="st7" d="M229.3 86l.2 6 15.3 4.9 4.6-2.4-15.1-11.7-15.2-1.3-4.5 2.4z" />
      <path id="polygon49" className="st7"
      ...
      <path id="polygon56" className="st8" d="M165.4 20.8l-4.5 2.5-8 49 4.5-2.4 7.7-27.5z" />
      <path id="polygon58" className="st3" d="M129.8 27.4l-3.6 1.9.3 1.2 8.5-5.4-3.7-4-4.8 2.4z" />
      <path id="polygon60" className="st7" d="M139.5 85.3l-36.3-18 4.5-3.5 36.3 19z" />
      <path id="polygon62" className="st3" d="M106.6 18.3l-5.5 10.4 5.8-1.7 4.2-11.2z" />
      <linearGradient id="path69_1_" gradientUnits="userSpaceOnUse" x1="471.821" y1="-632.309"
        x2="480.919" y2="-650.202" gradientTransform="matrix(1 0 0 -1 -413.451 -579.186)">
        <stop offset="0" style={{stopColor:"#105fa1"}} />
        <stop offset="1" style={{stopColor:"#1d2c5e"}} />
      </linearGradient>
      <path id="path69" className="st9"
      ...
      <path id="polygon71" className="st3"
      ...
      <path id="polygon78" className="st10" d="M16.5 54.9l19.4 43.9 18.4-5.9 4.5-3-38.2-40-4.8 2.9-3.8 4.1z" />
      <path id="path80" className="st3"
        d="M208.4 75.6l.3 2.2c1.6-.2 3.2-.4 4.7-.9 1.7-.6 5.3-2.2 6.6-3.4-.6.2-9 2.4-11.6 2.1" />
      <path id="path82" className="st3"
      ...
      <path id="polygon100" className="st13" d="M101.7 38.5l9.2-13-.4-.3-8.9 12.5z" />
      <path id="polygon102" className="st13"
        d="M162.8 36.8l-1.2 7.6L160 43l-.6 3.6-3.2-2.9 3.4-3.6 1-1.1v.1l1.2-1.2z" />
      <path id="polygon104" className="st13" d="M151.4 15.4l3.2-1.4-5.9-7.6-1.9 2.8z" />
      <path id="path106" className="st13"
      ...
      <path id="path108" className="st13"
      ...
      <path id="polygon132" className="st13" d="M169.6 25.2l-.4 2.2h9.8l2.9 15.9 2.2-2.2-2.3-16.8z" />
      <path id="polygon134" className="st13" d="M186.4 56l-3.2 8.2.8 2.2 4.5-12.5z" />
      <path id="polygon136" className="st13" d="M177 50.9l-2.2 2.2-2.4 14.8 2.3.8z" />
      <path id="path138" className="st13"
      ...
      <path id="path140" className="st13"
        d="M213.6 47.1c0 .1 2.2-2.2 2.2-2.2-2.7.1-4 1.4-3.8 2-.2.2-.3.5-.4.7.5-.3 1.6-.5 2-.5" />
      <path id="path142" className="st13"
        d="M218.6 50.5c.1.4.1.7.1 1.1 0 .5-.2 1-.4 1.4.4-.2 3.6-1.2 2.4-4.8.1.2-2.2 2.3-2.1 2.3" />
      <path id="path144" className="st13"
        d="M211.5 61.8c3 .1 6.4-1.7 8.8-5-6.1 1.3-12.6-9-12-10-2.3 1.7-4.4 4.9-4.5 7.2-.2 4.2 3.3 7.6 7.7 7.8" />
      <path id="polygon146" className="st13" d="M245.2 88.5l1.4.9 17.6-52.8-13.2-3-.1 3.1 10.6 2.3z" />
      <path id="polygon148" className="st13" d="M224.3 27.9l.1 3 14 2.8 5.4 25.6 2.2-2.2-5.2-25.9z" />
      <path id="polygon150" className="st13" d="M235.1 57.1l-3.9 21.8 2.2.7 3.9-24.7z" />
      <path id="polygon152" className="st13" d="M53.4 86.9l-6.5-23.8-2.4 1.7 6.1 22.7z" />
      <path id="path154" className="st13"
        d="M51.7 51.2c-1.5 1.6-4.9 4.7-6.8 5.9l-1.2-3.7-2.5-8.2-1.6-5.5-1.6 2 1.6 5.5 2.5 8.1 1.2 3.7c2.7-1.5 6.5-4.7 8.4-7.8" />
      <path id="path156" className="st12"
        d="M144.5 37.1c-2.1-.8-5-.6-6.6 1.2-.4.4-1.1 1.4-1.3 1.9 1.5-1.2 4.3-1.5 6-.8l1.9-2.3z" />
      <path id="path158" className="st12"
      ...
      <g id="g160" transform="translate(-5.451 -1.686)">
        <g id="g162">
          <path id="path164" className="st14"
      ...
      <g id="g166" transform="translate(-5.451 -1.686)">
        <g id="g168">
          <path id="path170" className="st15"
      ...
      <path id="path174" className="st17"
      ...
      <linearGradient id="path183_1_" gradientUnits="userSpaceOnUse" x1="639.706" y1="2062.77"
        ...
        <stop offset="0" style={{stopColor:"#3c5aa6" }}/>
        <stop offset=".933" style={{stopColor:"#2b73b9" }}/>
        <stop offset="1" style={{stopColor:"#2a75bb" }}/>
      </linearGradient>
      <path id="path183" className="st18"
      ...
      <g id="g185" transform="translate(-5.451 -1.686)">
        <g id="g187">
          ...
          <path id="path196" className="st19"
